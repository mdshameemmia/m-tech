...
@section('body')
    ...
    <div class="row card " style="background-color:rgb(247, 238, 238)">
               ...
               <div class="row m-3">
                ...
                <form action="{{route('subcontract_project.store')}}"  method="POST">
                    @csrf
                    ...
                    <div class="form-group row mx-4 ">
                      ...
                      <input type="text" name="project_name" id="" class="form-control col-md-5 mx-2 " placeholder="" aria-describedby="helpId">
                    </div>
                  
                    <div class="form-group row mx-4 ">
                      <label for="" class="col-md-12 font-weight-bold">Budget Amount  </label>
                      <input type="text" name="budget" id="" class="form-control col-md-5 mx-2 " placeholder="" aria-describedby="helpId">
                    </div>
                  
                    <div class="form-group row mx-4 ">
                      <label for="" class="col-md-12 font-weight-bold">Start Date   </label>
                      <input type="text" name="start_date" id="" class="form-control col-md-5 mx-2 date " placeholder="" aria-describedby="helpId">
                    </div>
                    <div class="form-group row mx-4 ">
                      <label for="" class="col-md-12 font-weight-bold">End Date  </label>
                      <input type="text" name="end_date" id="" class="form-control col-md-5 mx-2 date" placeholder="" aria-describedby="helpId">
                    </div>
