               ...
               <div class="row m-3">
                ...
                <form action="{{route('products.store')}}"  method="POST">
                    ...
                    <div class="form-group row mx-4 ">
                      ...
                      <input type="text" name="item_name" id="" class="form-control col-md-5 mx-2 " placeholder="" aria-describedby="helpId">
                    </div>
                    {{-- <div class="form-group row mx-4 ">
                      <label for="" class="col-md-12 font-weight-bold">Item Price  </label>
                      <input type="text" name="item_price" id="" class="form-control col-md-5 mx-2 " placeholder="" aria-describedby="helpId">
                    </div> --}}
                    <div class="form-group row mx-4 ">
                      <label for="" class="col-md-12 font-weight-bold">Unit   </label>
                      <input type="text" name="unit" id="" class="form-control col-md-5 mx-2 " placeholder="" aria-describedby="helpId">
                    </div>
                    <div class="form-group row mx-4 ">
