...
@section('body')
    ...
    <div class="row card " style="background-color:rgb(247, 238, 238)">
               <div class="row m-2 px-3">
                ...
                <form action="{{route('vendors.update',$quotation->id)}}"  method="POST" class="row">
                    @csrf
                    <div class="col-md-12 px-5">
                      <div class="form-group  ">
                        ...
                        <select name="company_id" class="form-control mx-2" id="company_id">
                          ...
                          @foreach ($companies as $company)
                              <option @if ($quotation->company_id==$company->id)
                                  selected
                      ...
                      <div class="form-group  ">
                        ...
                        <select name="project_id" class="form-control mx-2" id="">
                          <option value="">Select One</option>
                          <option selected value="{{$quotation->project_id??''}}">{{$quotation->project->title??''}}</option>
                      ...
                      <div class="form-group  ">
                        ...
                        <input type="text" value="{{$quotation->tel??''}}" name="tel" id="" class="form-control mx-2 tel" readonly placeholder="" aria-describedby="helpId">
                      </div>
                      <div class="form-group  ">
                        <label for="" class="col-md-12 font-weight-bold">Fax  </label>
                        <input type="text" value="{{$quotation->fax??''}}" name="fax" id="" class="form-control mx-2 fax" readonly placeholder="" aria-describedby="helpId">
                      </div>
                      <div class="form-group  ">
                        <label for="" class="col-md-12 font-weight-bold">Attention  </label>
                        <input type="text" value="{{$quotation->attention??''}}" name="attention" id="" class="form-control mx-2 attention " readonly placeholder="" aria-describedby="helpId">
                      </div>
  
                      <div class="form-group  ">
                        <label for="" class="col-md-12 font-weight-bold"> Date    </label>
                        <input type="text" value="{{$quotation->date??''}}" name="date" id="" class="form-control mx-2 date" placeholder="" aria-describedby="helpId">
                      </div>
                      ...
                      {{-- <div class="col-md-12 ">
                        <div class="row">
                         <h2 class="col-md-9">Project Description</h2>
                         <a role="button" ><button type="button" class="btn mx-1  btn-primary btn-sm btn-icon"><i class="fa fa-plus"></i> Product Add</button></a>
                        </div>
                         ...
                         <div class="row">
                            ...
                            <div class="col-md-2">
                              <div class="form-group">
                                ...
                                <input type="text" name="rate[]"  value="" class="form-control rate">
                              </div>
                            </div>
                            <div class="col-md-2">
                              <div class="form-group">
