...
@section('body')
    ...
    <div class="row card  p-3" style="background-color:rgb(247, 238, 238)">
               <div class="row m-2">
                ...
                <form action="{{route('vendors.quotation-description.store',$quotation->id)}}"  method="POST" class="row">
                    @csrf
                      ...
                      <div class="col-md-12 p-2">
                        <div class="row">
                         <h2 class="col-md-10 mx-3"></h2>
                         {{-- <a role="button" ><button type="button" class="btn mx-1  btn-primary btn-sm content-description"><i class="fa fa-plus"></i> Content Add</button></a> --}}
                         <a role="button" ><button type="button" class="btn mx-1 my-2  btn-primary btn-sm btn-icon"><i class="fa fa-plus"></i> Product Add</button></a>
                        </div>
                        ...
                        <div id="product_description">
                          <div class="row">
                            ...
                            <div class="form-group col-md-9">
                              <textarea name="product_description_title" class="form-control unit " id="" cols="30" rows="3"></textarea>
                              {{-- <input type="text" name="product_description_title"   class="form-control unit"> --}}
                            </div>
                          </div>
                         <div class="row">
                            <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <select name="product_id[]" class="form-control select2" id="product_id" onchange="getUnit(this)">
