...
@section('body')
    <div class="card m-0 p-3" style="background-color:rgb(247, 238, 238)">
        <div class="row m-0 p-0">
            ...
            <p class="col-md-1"><a href="{{ route('time-schedules.index') }}"><button class="btn btn-primary btn-sm"> Back
                    </button></a></p>
        </div>
        <form action="{{ route('time-schedules.update',$employee->id) }}" method="POST" class="row">
            @csrf
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group ">
                    ...
                    <input type="text" name="company_id"  value="{{$employee->company->name??''}}" id="" class="form-control " placeholder=""
                        aria-describedby="helpId">
                </div>
            </div>
            <div class="form-group ">
