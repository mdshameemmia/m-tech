...
@section('body')
    ...
    <div class="row card " style="background-color:rgb(247, 238, 238)">
               ...
               <div class="row m-3">
                ...
                <form action="{{route('subcontract.store')}}"  method="POST">
                    @csrf
                  
                    <div class="form-group row mx-4 ">
                      <label for="" class="col-md-12 font-weight-bold">Company Name </label>
                      <input type="text" name="company_name" id="" class="form-control col-md-5 mx-2 " placeholder="" aria-describedby="helpId">
                    </div>
                    ...
                    <div class="form-group row mx-4 ">
                      ...
                      <input type="text" name="mobile" id="" class="form-control col-md-5 mx-2 " placeholder="" aria-describedby="helpId">
                    </div>
                  
                    <div class="form-group row mx-4 ">
                      <label for="" class="col-md-12 font-weight-bold">Subcontractor Passport  </label>
                      <input type="text" name="passport" id="" class="form-control col-md-5 mx-2 " placeholder="" aria-describedby="helpId">
                    </div>
                    <div class="form-group row mx-4 ">
                      <label for="" class="col-md-12 font-weight-bold">Work Permit  No/IC/EP  </label>
                      <input type="text" name="work_permit_no" id="" class="form-control col-md-5 mx-2 " placeholder="" aria-describedby="helpId">
                    </div>
