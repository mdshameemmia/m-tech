...
class InvoiceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $invoice_count = Invoice::where('company_id',$request->company_id)->where('progress_claim_id',$progress_claim_id)->count();
    ...
    public function invoiceDownload($id)
    {
        try {
            // $invoice = Invoice::where('id',$id)->first();
            // $quotation = Quotation::where('company_id',$invoice->company_id)->pluck('quotation')->first();
            // $view =  view('invoices.pdf',compact('invoice','quotation'));
            // $mpdf = new Mpdf();
            // $mpdf->WriteHTML($view);
            // $mpdf->Output();
    ...
    {
        $progress_claims =  ProgressClaim::where('project_id',$request->title)->get();
